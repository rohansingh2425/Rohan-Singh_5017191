...
import com.example.employeemanagementsystem.EmployeeNameEmailProjection;
...
public class EmployeeController
{
    ...
    public List<Employee> getEmployeesByProjection(@RequestParam String departmentName) {
        return employeeRepository.findByDepartmentName(departmentName);
    }

    @GetMapping("/employees/dto")
    public List<EmployeeDTO> getEmployeesByDTO(@RequestParam String departmentName) {
