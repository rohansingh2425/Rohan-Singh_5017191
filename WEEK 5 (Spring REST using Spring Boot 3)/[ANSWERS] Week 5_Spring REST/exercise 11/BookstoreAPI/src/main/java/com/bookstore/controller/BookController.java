...
public class BookController {
    ...
    public ResponseEntity<BookDTO> createBook(@RequestBody BookDTO bookDTO) {
        ...
        responseBookDTO.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(BookController.class)
                .getBookById(responseBookDTO.getId())).withSelfRel());
    ...
    public ResponseEntity<BookDTO> getBookById(@PathVariable Long id) {
        ...
        bookDTO.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(BookController.class)
